...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-n0=qnuhn1o%h@obf$cx3o^hc1h372&5m2#3xagpfmu7yfiu^02')
...
# Media Files (Uploads, Book Covers)
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media'

# Shopping Cart Session Config
